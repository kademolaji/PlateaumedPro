...
namespace PlateaumedPro.Tests.Services
{
    ...
    {
        [Fact]
        public void TestTeacherServiceShouldReturnTrueStatusGivenRightInput()
        {
            // Given
           
            var auditTrailServiceMock = new Mock<IAuditTrailService>();
            var loggerServiceMock = new Mock<ILoggerService>();
            var teacherService = new TeacherServices(MockContext, auditTrailServiceMock.Object);
            ...
            // When
            var order = teacherService.CreateTeacher(teacher).GetAwaiter().GetResult();
            // Then
        ...
        //{
        //    // Given
        //    var channels = PlateaumedProFaker.GetChannels();
